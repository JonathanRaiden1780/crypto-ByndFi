            ...
            <div className="offcanvas offcanvas-end" tabIndex={-1} id="switcher-canvas" aria-labelledby="offcanvasRightLabel">
                <div className="offcanvas-header border-bottom">
                    ...
                    <Button variant='' onClick={() => {
                        Switcherclose();
                    }} type="button" className="btn-close border-0" data-bs-dismiss="offcanvas" aria-label="Close"></Button>
                </div>
                    ...
                    <Tab.Container id="left-tabs-example" defaultActiveKey="react">
                        <nav className="border-bottom border-block-end-dashed">
                            <Nav variant="pills" className="nav nav-tabs nav-justified switcher-main-tabs" id="switcher-main-tab" role="tablist">
                                <Nav.Item className='mb-0 me-0'>
                                    <Nav.Link as="a" className="p-0" eventKey="react"> <Button variant="" className="nav-link" id="switcher-home-tab" data-bs-toggle="tab" data-bs-target="#switcher-home"
                                        type="button" role="tab" aria-selected="true">Theme Styles</Button></Nav.Link>
                                </Nav.Item>
                                <Nav.Item className='mb-0'>
                                    <Nav.Link as="a" className="p-0" eventKey="firebase"> <Button variant="" className="nav-link" id="switcher-profile-tab" data-bs-toggle="tab" data-bs-target="#switcher-profile"
                                        ...
                                        <div className="col-6">
                                            <div className="form-check switch-select">
                                                ...
                                                <input className="form-check-input" type="radio" name="sidemenu-layout-styles"
                                                    id="switcher-default-menu" defaultChecked onChange={e => { }}

...
const Header = ({ local_varaiable, ThemeChanger }: any) => {
    ...
    const handleItemClick = () => {
        router.push("/components/mail/email/");
    }
                    ...
                    <div className="header-content-right">
                            ...
                            <Dropdown.Menu as="ul" className="main-header-dropdown  dropdown-menu-end"  >
                                <Dropdown.Header className="p-3  bg-header-image p-3 text-fixed-white">
                                    <div className="d-flex align-items-center justify-content-between">
                                        ...
                                        <div>
                                            <Link href="/components/ecommerce/checkout/" className="min-w-fit-content btn btn-sm btn-white ms-2 my-auto">Checkout</Link>
                                        </div>
                                    </div>
                                </Dropdown.Header>
                                ...
                                <SimpleBar id="header-dropdown-scroll1">
                                            ...
                                            <Dropdown.Item as="li" className="dropdown-item d-flex align-items-center position-relative" key={idx.id} >
                                                ...
                                                <div className="flex-grow-1 overflow-hidden">
                                                    <div className="d-flex align-items-center">
                                                        <Link href={"/components/ecommerce/cart/"} className="mb-0 text-truncate flex-grow-1 h6">{idx.name}</Link>
                                    ...
                                    <div className={`p-3 empty-header-item1 border-top ${cartItems.length === 0 ? "d-none" : "d-block"}`}>
                                        <div className="d-grid">
                                            <Link href={"/components/ecommerce/cart/"} className="btn btn-primary">View All</Link>
                                        </div>
                                    </div>
                                </SimpleBar>
                            ...
                            <Dropdown.Menu className="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none" >
                                <Dropdown.Header className="p-3 dropdown-header bg-header-image p-3 text-fixed-white">
                                    <div className="d-flex align-items-end justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <Link className="min-w-fit-content btn btn-white btn-sm ms-2" href={"/components/mail/emailservices/"}>View All</Link>
                                        </div>
                                    </div>
                                </Dropdown.Header>
                                <Dropdown.Divider className="dropdown-divider"></Dropdown.Divider>
                                <div >
                                            ...
                                            <Dropdown.Item as="li" key={index} >
                                                ...
                                                <div className="d-flex align-items-center position-relative">
                                                    ...
                                                    <div className="d-flex">
                                                        <div className="flex-grow-1 overflow-hidden">
                                                            <Link href={"/components/mail/emailservices/"} className="mb-1" onClick={handleLinkClick}>{notification.name}</Link>
                                    ...
                                    <div className={`p-3 empty-header-item1 border-top ${notifications.length === 0 ? "d-none" : "d-block"}`}>
                                        <div className="d-grid">
                                            <Link href={"/components/pages/notifications"} className="btn btn-primary">View All</Link>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <Dropdown.Menu className="main-header-dropdown header-shortcuts-dropdown dropdown-menu pb-0 dropdown-menu-end">
                                <div className="p-3 dropdown-header bg-header-image text-fixed-white">
                                    <div className="d-flex align-items-center justify-content-between">
                                        ...
                                        <div>
                                            <Link className="min-w-fit-content btn btn-sm btn-white ms-2" href={"/components/mail/email/"} >View All</Link>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <Dropdown className="header-element header-profile">
                            ...
                            <Dropdown.Menu as="ul" className="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                                ...
                                <Dropdown.Item as="li" className="d-flex">
                                    <Link href={"/components/mail/emailservices/"}><i className="ti ti-inbox fs-18 me-2 op-7"></i>Inbox </Link> <span className="badge bg-success-transparent ms-auto">25</span></Dropdown.Item>
                                <Dropdown.Item as="li" className="d-flex">
                                    <Link href={"/components/mail/readmessages/"}><i className="ti ti-adjustments-horizontal fs-18 me-2 op-7"></i>Settings</Link></Dropdown.Item>
                                <Dropdown.Item as="li" className="d-flex">
                                ...
                                <Dropdown.Item as="li" className="d-flex">
                                    <Link href={"/components/custompages/login/"}><i className="ti ti-logout fs-18 me-2 op-7"></i>Log Out</Link></Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>

...
export const Solidalerts: Solid[] = [
  ...
  { id: 8, text: "A simple solid dark alert-check it out!", class: "solid-dark", color: '' }
...
export const Svgalert: svgalert[] = [
  ...
  { id: 2, class1: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z", text1: "Confirmed Alert", text2: 'Success alert to show to success message', color: 'success', btn1: 'cancel', btn2: 'open', class: "danger" },
...
export const Svgalert1: svgalert1[] = [
  ...
  { id: 2, class1: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z", text1: "Confirmed Alert", text2: 'Success alert to show to success message', color: 'success', btn1: '', btn2: 'close', class: "" },

...
export const Avatarsizes: avatarsizes[] = [
    ...
    { id: 6, src: "../../../assets/images/faces/10.jpg", class: 'xxl' },
];
...
export const Avataricons: avataricons[] = [
    { id: 1, src: "../../../assets/images/faces/2.jpg", class: 'xs', color: 'success', icon: 'fe fe-camera', text: '2' },
    { id: 2, src: "../../../assets/images/faces/3.jpg", class: 'sm', color: 'secondary', icon: 'fe fe-edit', text: '5' },
    { id: 3, src: "../../../assets/images/faces/14.jpg", class: 'md', color: 'warning', icon: 'fe fe-plus', text: '1' },
    { id: 4, src: "../../../assets/images/faces/13.jpg", class: 'lg', color: 'info', icon: 'fe fe-edit', text: '7' },
    { id: 5, src: "../../../assets/images/faces/15.jpg", class: 'xl', color: 'success', icon: 'fe fe-camera', text: '3' },
    { id: 6, src: "../../../assets/images/faces/10.jpg", class: 'xxl', color: 'danger', icon: 'fe fe-plus', text: '9' }
];

...
//charts
export class Audience extends React.Component<{}, { options: any, series: any }> {
...
//Session charttt
export class Sessions extends Component<{}, { options: any, series: any }>{
  constructor(props: any) {
    super(props);
...
export class Users extends Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);
...
//NEW SESSION CHART
export class NewSession extends Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);
...
// Statics Ratio 1
export class Stats1 extends Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);
...
// Statics Ratio 2
export class Stats2 extends Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);
...
// Statics Ratio 3
export class Stats3 extends Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);
...
// Statics Ratio 4
export class Stats4 extends Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);
...
//BOUNCE RATE CHART
export class Bounce extends Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);
...
export class Monthlystat extends React.Component <{}, { options: any, series: any }> {
  constructor(props:any) {
    super(props);
...
//TOTAL USERS
export class Totalusers extends React.Component<{}, { options: any, series: any, selection: any }> {
  constructor(props: any) {
    super(props);
    ...
    this.state = {
      ...
      series: [{
        name: 'This year',
        data: [
          [0, 45], [1, 43], [2, 47], [3, 45], [4, 45], [5, 45], [6, 42], [7, 43], [8, 45], [9, 45],
          [10, 47], [11, 42], [12, 40], [13, 41], [14, 38], [15, 42], [16, 36], [17, 42], [18, 38],
          [19, 35], [20, 35], [21, 35], [22, 33], [23, 31], [24, 28], [25, 30], [26, 26], [27, 22],
          [28, 31], [29, 31], [30, 33], [31, 35], [32, 42], [33, 42], [34, 35], [35, 38], [36, 38],
          [37, 30], [38, 31], [39, 32], [40, 38], [41, 42], [42, 37], [43, 42], [44, 44], [45, 44],
          [46, 42], [47, 39], [48, 37], [49, 40], [50, 42], [51, 37], [52, 40], [53, 42], [54, 37],
          [55, 32], [56, 36], [57, 37], [58, 38], [59, 42], [60, 40], [61, 40], [62, 43], [63, 43],
          [64, 41], [65, 40], [66, 43], [67, 46], [68, 47], [69, 42], [70, 39], [71, 41], [72, 45],
          [73, 47], [74, 51], [75, 45], [76, 50], [77, 52], [78, 50], [79, 56], [80, 55], [81, 54],
          [82, 57], [83, 58], [84, 61], [85, 61], [86, 64], [87, 57], [88, 55], [89, 48], [90, 44],
          [91, 44], [92, 47], [93, 47], [94, 51], [95, 45], [96, 47], [97, 42], [98, 44], [99, 42],
          [100, 49]
        ],
        color: "#00D1A2",
      }],
        ...
        xaxis: {
          labels: {
            formatter: function (val: any) {
              return ["Jan", "", "", "", "", "", "", "", "", "Feb", "", "", "", "", "", "", "", "", "Mar", "", "", "", "", "", "", "", "", "Apr", "", "", "", "", "", "", "", "", "May", "", "", "", "", "", "", "", "", "Jun", "", "", "", "", "", "", "", "", "July", "", "", "", "", "", "", "", "", "Aug", "", "", "", "", "", "", "", "", "Sep", "", "", "", "", "", "", "", "", "Oct", "", "", "", "", "", "", "", "", "Nov", "", "", "", "", "", "", "", "", "Dec"][val];
            }
          }
        },
        yaxis: {
  ...
  render() {
    return (
      ...
      <div id="chart-timeline">
        <ReactApexChart options={this.state.options} series={this.state.series} type="area" height={211} />
      </div>
  ...
  return (
    ...
    <div>
      <div className="controls">
        <div>
          <Button variant='primary' className='p-0' onClick={handleZoomIn}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3">
              <line x1="12" y1="5" x2="12" y2="19" />
              <line x1="5" y1="12" x2="19" y2="12" />
            </svg>
          </Button>
          <Button variant='primary' className='p-0 ms-1' onClick={handleZoomOut}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3">
              <line x1="5" y1="12" x2="19" y2="12" />
            </svg>
          </Button>
...
export class TrafficSource extends Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);
...
export class Bouncerate extends React.Component<{}, { options: any, series: any, selection: string }> {
  constructor(props: any) {
    super(props);
...
//
export class EXPENSESdashboard extends Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);
...
//
export class PROFITdashboard extends Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);

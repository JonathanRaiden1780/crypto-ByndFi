...
export const DonutChartData = {
  ...
  datasets: [{
    ...
    backgroundColor: ['rgba(74, 119, 240,0.8)', 'rgba(253, 197, 48,0.8)', 'rgba(0, 209, 162,0.9)', 'rgba(230, 61, 89,0.9)'],
    borderColor: ['rgba(74, 119, 240,0.2)', 'rgba(253, 197, 48,0.2)', 'rgba(0, 209, 162,0.4)', 'rgba(230, 61, 89,0.2)'],
  }]
};
...
export class Monthly extends React.Component<{}, { options: any, series: any }> {
...
export class Sales extends React.Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);
...
export class Inventory extends React.Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);
      ...
      options: {
        chart: {
          events: {
            ...
            click: function (_chart: any, _w: any, _e: any) {
            },
            height: 200,
            type: 'bar',
            toolbar: {
        ...
        colors: ['rgba(29, 193, 152,0.9)', 'rgba(29, 193, 152,0.9)', 'rgba(29, 193, 152,0.9)', 'rgba(29, 193, 152,0.9)', 'rgba(29, 193, 152,0.9)'],
        plotOptions: {
          bar: {
            columnWidth: '25%',
            distributed: true,
  ...
  if (completed) {
    ...
    return (
      <>
        ...
        <ul className='countdown d-flex gap-2 justify-content-lg-end'>
          <li>
...
export function DayCounter() {
  return (<Countdown date={Date.now() + 33670860000} renderer={rendering} />);
}

//Daily Statistics
export class Totalproducts extends React.Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);
  ...
  render() {
    return (
      ...
      <ReactApexChart options={this.state.options} series={this.state.series} type="line" height={35} width={100} />

    );
  }
}
//
export class Delivered extends React.Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);
...
export class Pending extends React.Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);
...
export class Onhold extends React.Component<{}, { options: any, series: any }> {
  constructor(props: any) {
    super(props);

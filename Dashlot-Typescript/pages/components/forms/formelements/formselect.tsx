...
import { Multipleselectdata, Multipleselectdata1, Optionwithnosearch, SingleGroup, SingleGroup1 } from '../../../../shared/data/forms/formslectdata';
...
const Formselect = () => {
    ...
    return (
        <Fragment>
            ...
            <PageheaderDB heading="Form Elements" active="Form Select" />

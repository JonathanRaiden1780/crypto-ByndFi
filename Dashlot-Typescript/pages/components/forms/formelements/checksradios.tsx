...
const Checksradios = () => {
    ...
    return (
        <Fragment>
            ...
            <PageheaderDB heading="Form Elements" active="Checks & Radios" />
            <div className="main-container container-fluid">
                ...
                <Row>
                    ...
                    <Col xl={3} lg={6} md={6} sm={12} >
                        <ShowCode title="Radios" customCardClass="custom-card" customCardBodyClass="" code={radio3}>
                            <Form.Check type="radio" label="Default radio" name="flexRadioDefault" />
                            <Form.Check type="radio" defaultChecked label="Default checked radio" name="flexRadioDefault" />
                ...
                <Row>
                    <Col xl={6} lg={12} md={12} sm={12}>
                        <ShowCode title="Inline" customCardClass="custom-card" customCardBodyClass="" code={radio9}>
                            ...
                            <Form.Check className="form-check-inline" name="inline-radio" type="radio" label="1" />
                            <Form.Check className="form-check-inline" name="inline-radio" type="radio" label="2" />
                            <Form.Check className="form-check-inline" disabled type="radio" label="3 (disabled)" />
                        </ShowCode>
                        <ShowCode title="Without labels" customCardClass="custom-card" customCardBodyClass="d-flex" code={radio10}>
                ...
                <Row className="row row-cols-12">
                    ...
                    <Col md={12} className='col-lg col-xl'>
                    ...
                    <Col xl={6} lg={6} md={6} sm={12}>
                        <ShowCode title=" Toggle Switches Style-1 " customCardClass="custom-card" customCardBodyClass="" code={radio16}>
                            <Row className=" gy-1">
                                ...
                                <Col xl={4}>
                                    <div className={`toggle toggle-primary  ${primary1}`} onClick={() => { primary1 == "on" ? setprimary1("off") : setprimary1("on"); }}>
                                        <span></span>
                                    </div>
                                </Col>
                                <Col xl={4}>
                    ...
                    <Col xl={6} lg={12} md={12} sm={12}>
                        <ShowCode title="Toggle Switch-1 Sizes" customCardClass="custom-card" customCardBodyClass="" code={radio18}>
                            <div className="d-flex align-items-center flex-wrap mb-3">
                                ...
                                <div className={`toggle  toggle-primary toggle-sm mb-0 ${primary2}`} onClick={() => { primary2 == "on" ? setprimary2("off") : setprimary2("on"); }}>
                                    <span></span>
                                </div>
                            </div>
                            <div className="d-flex align-items-center flex-wrap mb-3">

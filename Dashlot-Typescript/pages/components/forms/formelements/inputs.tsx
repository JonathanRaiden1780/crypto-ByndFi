...
const Inputs = () => {
    return (
        ...
        <Fragment>
            <Seo title={"Inputs"} />
            <PageheaderDB heading="Form Elements" active="Inputs" />
                        ...
                        <ShowCode title="Input Types" customCardClass="custom-card" customCardBodyClass="" code={input1}>
                            <div className="row gy-4">
                                <Col xl={4} lg={6} md={6} sm={12}>
                                    ...
                                    <Form.Label htmlFor="input-text">Basic Input:</Form.Label>
                                ...
                                <Col xl={4} lg={6} md={6} sm={12}>
                                    <Row>
                                        ...
                                        <Col xl={5}>
                                            <div className="ps-0">
                                                <p className="mb-3 px-0 ">Type Checkbox</p>
                                        ...
                                        <Col xl={4}>
                                            <div className="ps-0">
                                                <p className="mb-3 px-0 ">Type Radio</p>
                                                <Form.Check
                                ...
                                <fieldset disabled>
                                    ...
                                    <div className="mb-3">
                                        <Form.Label htmlFor="disabledSelect">Disabled select
                                            menu</Form.Label>
                                        <select id="disabledSelect" className="form-select bg-light">

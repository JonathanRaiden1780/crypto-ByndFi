...
const AboutUs = () => {
   return (
      <Fragment>
         <Seo title={"About Us"} />
         <PageheaderDB heading="Pages" active="About" />
            ...
            <div className="container">
               ...
               <Row className="mb-5 justify-content-center">
                  <Col lg={8} md={8} sm={12} className="text-center">
                     <h1 className="mb-3 font-weight-semibold tx-46">Hello! This is <span className="text-primary tx-56">Dashlot.</span></h1>
                     ...
                     <p className="leading-normal  tx-16">There are many variations of passages of Lorem Ipsum available, but the majority have suffered  by injected humour, or randomised words which don't look even slightly believable.
                        If you are going to use Link passage of Lorem Ipsum you are going to use Link passage of Lorem Ipsum</p>
                  </Col>
               </Row>

               <Row className="mx-0">
                  <Card className="overflow-hidden px-0">
                     <img src="../../../assets/images/background/27.jpg" alt="image" />
                  </Card>
               </Row>
                        ...
                        <Card.Body>
                           <div className="statistics-info p-4">
                              <Row>
                                 <Col xl={6}>
                                    <div className="">
                                       <h2 className="fw-bold mb-4 text-default">We Help to <span className="text-primary">Build</span> Your Dream Project.</h2>
                                       <h5 className="leading-normal fw-normal mb-4 text-default">majority have suffered alteration in some form, by injected humour</h5>
                                       ...
                                       <p> If you are going to use Link passage of Lorem Ipsum, you need to as necessary All the Lorem Ipsum generators on the Internet tend to repeat Various versions have evolved over the years, sometimes by
                                          accident, sometimes on purpose (injected humour and the like).</p>
                                    </div>
                                 </Col>
                                 <Col xl={6}>
                                    <div className="text-center">
                                       <img src="../../../assets/images/png/03.png" alt="" className='img-fluid' />
                                    </div>
                                 </Col>
                              </Row>
                           </div>
               ...
               <Row>
                  <Col xl={3} lg={6} md={6}>
                     <Card className="bg-success-transparent">
                        <Card.Body>
                           <div className="counter-status md-mb-0">
                              <div className="text-center mb-1">
                                 <svg className="about-icons" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"><path fill="#45bf05"
               ...
               <Row>
                     ...
                     <Card className="p-3">
                        <Card.Body>
                           <div className="mb-3 text-center about-team">
                              <img className="rounded-circle" src="../../../assets/images/users/3.jpg" alt="image" />
                           </div>
                           ...
                           <div className="text-center tx-14 mb-3">Lorem ipsum dolor, amet consectetur adipisicing. Quibusdam similique provident!</div>
                           <div className="btn-list text-center">
                              <Button type="button" className="btn btn-sm btn-primary"><i className="fa fa-facebook"></i></Button>
                              <Button type="button" className="btn btn-sm btn-info"><i className="ri-twitter-x-line"></i></Button>
                              <Button type="button" className="btn btn-sm btn-danger" variant=''><i className="fa fa-google"></i></Button>
                           </div>
                        </Card.Body>
                     </Card>
                  </Col>
                  <Col xl={3} lg={6} md={6} sm={12}>
                     <Card className="p-3">
                        <Card.Body>
                           <div className="mb-3 text-center about-team">
                              <img className="rounded-circle" src="../../../assets/images/users/10.jpg" alt="image" />
                           </div>
                           <div className="tx-16 text-center font-weight-semibold">
                              Mclaren mcannen
                           </div>
                           ...
                           <div className="text-center tx-14 mb-3">Lorem ipsum dolor, amet consectetur adipisicing. Quibusdam similique provident!</div>
                           <div className="btn-list text-center">
                              <Button className="btn-sm btn-primary"><i className="fa fa-facebook"></i></Button>
                              <Button className="btn-sm btn-info"><i className="ri-twitter-x-line"></i></Button>
                              <Button className="btn-sm btn-danger" variant=''><i className="fa fa-google"></i></Button>
                           </div>
                        </Card.Body>
                     </Card>
                  </Col>
                  <Col xl={3} lg={6} md={6} sm={12}>
                     <Card className="p-3">
                        <Card.Body>
                           <div className="mb-3 text-center about-team">
                              <img className="rounded-circle" src="../../../assets/images/users/4.jpg" alt="image" />
                           </div>
                           <div className="tx-16 text-center font-weight-semibold">
                              Shimpa Craig
                           </div>
                  ...
                  <Col xl={3} lg={6} md={6} sm={12}>
                     <Card className="p-3">
                        <Card.Body>
                           <div className="mb-3 text-center about-team">
                              <img className="rounded-circle" src="../../../assets/images/users/5.jpg" alt="image" />
                           </div>
                           <div className="tx-16 text-center font-weight-semibold">
                              Limo Peter
                           </div>
                           ...
                           <div className="btn-list text-center">
                              <button type="button" className="btn btn-sm btn-primary"><i className="fa fa-facebook"></i></button>
                              <button type="button" className="btn btn-sm btn-info"><i className="ri-twitter-x-line"></i></button>
                              <button type="button" className="btn btn-sm btn-danger"><i className="fa fa-google"></i></button>
                           </div>
                        </Card.Body>
                     </Card>
                  </Col>

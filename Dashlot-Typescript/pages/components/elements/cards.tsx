...
import { Backgroundcards, Gridcards, Gridmarkupcards, Mountaincards } from '../../../shared/data/elements/cardsdata';
...
const Cards = () => {
    ...
    return (
        <Fragment>
            <Seo title={"Cards"} />
            <PageheaderDB heading="Ui Elements" active="Cards" />
            <div className="main-container container-fluid">
                <Row>
                    <Col xxl={3} xl={6} lg={6} md={6} sm={12}>
                        <Card className="custom-card">
                            <img src="../../../assets/images/media/80.jpg" className="card-img-top" alt="..." />
                            <Card.Body>
                    ...
                    <Col xxl={3} xl={6} lg={6} md={6} sm={12}>
                        <Card className="custom-card">
                            <img src="../../../assets/images/media/81.jpg" className="card-img-top" alt="..." />
                            <Card.Body>
                    ...
                    <Col xxl={3} xl={6} lg={6} md={6} sm={12}>
                        <Card className="custom-card">
                            <img src="../../../assets/images/media/82.jpg" className="card-img-top" alt="..." />
                            <Card.Body>
                                <h6 className="card-title fw-semibold">Card title</h6>
                                <p className="card-text">Some quick example text to build on the card title and
                                    make up the bulk of the card's content.</p>
                    ...
                    {Mountaincards.map((idx) => (
                        <Col xl={2} key={Math.random()}>
                            <Card className="custom-card">
                                <Card.Body>
                                    <img src={idx.src} className="card-img mb-3" alt="..." />
                                    <h6 className="card-title fw-semibold mb-3">{idx.text1}<Badge bg={idx.color} className={`float-end fs-10 text-${idx.class}`}>{idx.text2}</Badge></h6>
                                    <p className="card-text">With supporting text below as a natural
                                        lead-in.</p>
                                </Card.Body>
                            </Card>
                        ...
                        <Card className="custom-card">
                            <Card.Header className="card-header justify-content-between">
                                ...
                                <Modal show={fullscreenshow} fullscreen={fullScreen} onHide={() => setfullscreenShow(false)}>
                                    <Modal.Header>
                                        <div className="card-title fw-semibold">Card With Fullscreen Button</div>
                ...
                <Row>
                    <Col xl={4}>
                        <Card className="custom-card">
                            <img src="../../../assets/images/media/87.jpg" className="card-img-top" alt="..." />
                            <Card.Body>
                    ...
                    <Col xl={4}>
                        <Card className="custom-card">
                            ...
                            <img src="../../../assets/images/media/86.jpg" className="card-img-bottom" alt="..." />
                        </Card>
                    </Col>
                    <Col xl={4}>
                        <Card className="custom-card">
                            ...
                            <img src="../../../assets/images/media/88.jpg" className="card-img rounded-0" alt="..." />
                            <Card.Body>
                                <p className="card-text mb-0"><small>Last updated 3 mins
                                    ago</small></p>
                            </Card.Body>
                    ...
                    <Col xl={4}>
                        <Card className="custom-card">
                            ...
                            <img src="../../../assets/images/media/89.jpg" className="card-img rounded-0" alt="..." />
                            <Card.Footer className="card-footer">
                                <p className="card-text mb-0"><small>Last updated 3 mins
                                    ago</small></p>
                            </Card.Footer>
                    ...
                    <Col xl={4}>
                        <Card className="custom-card">
                            <img src="../../../assets/images/media/90.jpg" className="card-img-top" alt="..." />
                            <Card.Header>
                                <Card.Title>Image caps are widely used in Blog's</Card.Title>
                            </Card.Header>
                            <Card.Body>
                    ...
                    <Col xl={4}>
                        <Card className="custom-card">
                            ...
                            <img src="../../../assets/images/media/91.jpg" className="card-img-bottom" alt="..." />
                        </Card>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col xl={4}>
                        <Card className="custom-card overlay-card">
                            <img src="../../../assets/images/media/93.jpg" className="card-img" alt="..." />
                    ...
                    <Col xl={4}>
                        <Card className="custom-card overlay-card">
                            <img src="../../../assets/images/media/94.jpg" className="card-img" alt="..." />
                    ...
                    <Col xl={4}>
                        <Card className="custom-card overlay-card">
                            <img src="../../../assets/images/media/92.jpg" className="card-img" alt="..." />
                            <div className="card-img-overlay d-flex flex-column p-0">
                                <Card.Header>
                                    <div className="card-title text-fixed-white">
                                        Image Overlays Are Awesome!
                                ...
                                <Card.Body className="card-body text-fixed-white overflow-y-scroll">
                    ...
                    <Col xl={4}>
                        <Card className="custom-card">
                            <div className="row g-0">
                                <Col md={4}>
                                    <img src="../../../assets/images/media/95.jpg" className="img-fluid rounded-start h-100 w-100" alt="..." />
                                </Col>
                                <Col md={8}>
                                    <Card.Header>
                    ...
                    <Col xl={4}>
                        <Card className="custom-card">
                            <Row className="row g-0">
                                ...
                                <Col md={4}>
                                    <img src="../../../assets/images/media/96.jpg" className="img-fluid rounded-end h-100 w-100" alt="..." />
                                </Col>
                            </Row>
                        </Card>
                    </Col>
                    <Col xl={4}>
                        <Card className="custom-card">
                            <div className="row g-0">
                                ...
                                <Col md={4}>
                                    <img src="../../../assets/images/media/97.jpg" className="img-fluid rounded-end h-100 w-100" alt="..." />
                                </Col>
                            </div>
                        </Card>
                    </Col>
                ...
                <Row>
                    <Col xl={12}>
                        <div className="card-group">
                            <Card className="custom-card">
                                <img src="../../../assets/images/media/98.jpg" className="card-img-top" alt="..." />
                                <Card.Body>
                            ...
                            <Card className="custom-card">
                                <img src="../../../assets/images/media/99.jpg" className="card-img-top" alt="..." />
                                <Card.Body>
                            ...
                            <Card className="custom-card">
                                <img src="../../../assets/images/media/100.jpg" className="card-img-top" alt="..." />
                                <Card.Body>
                ...
                <Row>
                            ...
                            <Col xxl={7} xl={12}>
                                <Card className="custom-card">
                                    ...
                                    <div className="row g-0">
                                        <Col md={8}>
                                            <Card.Body>
                                                <h6 className="card-title mb-2 fw-semibold">Dog is Beautiful ?</h6>
                                        ...
                                        <Col md={4}>
                                            <img src="../../../assets/images/media/106.jpg" className="img-fluid rounded-end h-100" alt="..." />
                                        </Col>
                                    </div>
                                </Card>
                            </Col>
                    ...
                    <Col xxl={3} xl={6}>
                        <Card className="custom-card">
                            <Link href="#!" className="card-anchor"></Link>
                            <img src="../../../assets/images/media/105.jpg" className="card-img-top" alt="..." />
                            <Card.Body>

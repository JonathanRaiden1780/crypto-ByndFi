...
import { AlignmentButtons, AutocloseButtons, CustomButtons, GhostButtons, OutlineButtons, SingleButtons, SplitButtonsdata } from '../../../shared/data/elements/dropdownsdata';
...
const Dropdowns = () => {
    ...
    return (
        <Fragment>
            <Seo title={"Dropdowns"} />
            <PageheaderDB heading="Ui Elements" active="Dropdowns" />
                    ...
                    <Col xl={6}>
                        <ShowCode title="Split buttons" customCardClass="custom-card" customCardBodyClass="" code={dropdown6}>
                            {SplitButtonsdata.map((idx) => (
                                <SplitButton key={Math.random()} className='me-2 mb-2'
                                    variant={idx.class}
                                    title="Action"
                                >
                        ...
                        <ShowCode title="Dropdown Sizing" customCardClass="custom-card" customCardBodyClass="" code={dropdown7}>
                            ...
                            <div className="btn-group my-1 me-2">
                                <Dropdown as={ButtonGroup}>
                                    <Button variant="light" className='btn btn-light btn-lg'>Large split button</Button>
                                    <Dropdown.Toggle split variant="light" id="dropdown-split-basic" className="" />
                                    <Dropdown.Menu>
                ...
                <Row>
                    ...
                    <Col xxl={3} xl={6}>
                        <ShowCode title="Dropup centered" customCardClass="custom-card" customCardBodyClass="" code={dropdown16}>
                            <p className="card-title mb-3">Use <code>.dropup-center</code> on the parent element.
                            </p>
                ...
                <Row>
                    ...
                    <Col xl={4}>
                        <ShowCode title="Responsive alignment end" customCardClass="custom-card" customCardBodyClass="responsive-dropdown" code={dropdown22}>
                            ...
                            <div className="btn-group">
                                <DropdownButton variant='warning' as={ButtonGroup} align={{ lg: 'end' }} title="Left-aligned but right aligned when large screen" id="dropdown-menu-align-responsive-1" className="text-wrap">

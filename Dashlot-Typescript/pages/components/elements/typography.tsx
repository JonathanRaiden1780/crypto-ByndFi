...
const Typography = () => {
    ...
    return (
        <Fragment>
            ...
            <PageheaderDB title="Typography" heading="Ui Elements" active="Typography" />
                ...
                <Row>
                    ...
                    <Col xl={6}>
                        <ShowCode title="Display headings" customCardClass="custom-card" customCardBodyClass="" code={typography3}>
                            <h1 className="display-1 mb-2">Display 1</h1>
                            <h1 className="display-2 mb-2">Display 2</h1>
                            <h1 className="display-3 mb-2">Display 3</h1>
                            <h1 className="display-4 mb-2">Display 4</h1>
                            <h1 className="display-5 mb-2">Display 5</h1>
                    ...
                    <Col xl={6}>
                        <ShowCode title="Description list alignment" customCardClass="custom-card" customCardBodyClass="" code={typography8}>
                            <dl className="row mb-0">
                                ...
                                <dd className="col-sm-9 d-sm-flex d-block">

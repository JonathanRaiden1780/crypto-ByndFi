...
const Toasts = () => {
    ...
    return (
        <Fragment>
            <Seo title={"Toasts"} />
            <PageheaderDB heading="Ui Elements" active="Toasts" />
            <div className="main-container container-fluid">
                <Row>
                    <Col xl={4}>
                        <ShowCode title="Live example" customCardClass="custom-card" customCardBodyClass="" code={toast4}>
                            <Button type="button" className="btn btn-primary btn-wave" id="liveToastBtn" onClick={() => setShowlive(true)}>Show live
                                toast</Button>
                            <ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
                                <Toast id="liveToast" className="toast fade show" role="alert" aria-live="assertive" aria-atomic="true" onClose={() => setShowlive(false)} show={showlive} delay={3000} autohide>
                                    <Toast.Header className="text-default">
                                        ...
                                        <strong className="me-auto">Dashlot</strong> <small>11 mins ago</small>
                                    </Toast.Header>
                        ...
                        <ShowCode title=" Color schemes" customCardClass="custom-card" customCardBodyClass="" code={toast5}>
                            <Toast className="toast align-items-center text-bg-primary border-0 fade show mb-4" show={showC}>
                                <div className="d-flex">
                                    <Toast.Body className=" text-fixed-white" > Hello, world! This is the Primary toast message.</Toast.Body>
                            ...
                            <Toast className="toast align-items-center text-bg-secondary border-0 fade show mb-4" show={showD}>
                                <div className="d-flex">
                                    <Toast.Body className=" text-fixed-white" > Hello, world! This is the secondary toast message.</Toast.Body>
                            ...
                            <Toast className="toast align-items-center text-bg-success border-0 fade show mb-4" show={showE}>
                                <div className="d-flex">
                                    <Toast.Body className=" text-fixed-white" > Hello, world! This is the success toast message.</Toast.Body>
                            ...
                            <Toast className="toast align-items-center text-bg-info border-0 fade show " show={showF}>
                                <div className="d-flex">
                                    <Toast.Body className=" text-fixed-white" > Hello, world! This is the info toast message.</Toast.Body>
                        ...
                        <ShowCode title="Basic example" customCardClass="custom-card" customCardBodyClass="" code={toast6}>
                            <Toast show={showA} onClose={toggleShowA} className="toast show"
                                ...
                                <Toast.Header className="text-default">
                                    ...
                                    <strong className="me-auto">Dashlot</strong>
                ...
                <Row>
                    <Col xl={12}>
                        <ShowCode title=" Toast Placements " customCardClass="custom-card" customCardBodyClass="" code={toast3}>
                            <div className="btn-list">

...
import { CustomProgress2data, CustomProgress4data, Multipleprogress } from '../../../shared/data/elements/progressbardata';
...
const Progress = () => {
    return (
        <Fragment>
            <Seo title={"Progress"} />
            <PageheaderDB heading="Ui Elements" active="Progress" />

...
import { Colorheaderalerts, Colredalerts, Defaultalerts, Dismissiblealerts } from '../../../shared/data/elements/popoverdata';
import PageheaderDB from '../../../shared/layout-components/pageheader/pageheaderDB';
import Link from 'next/link';
import Seo from '@/shared/layout-components/seo/seo';
import ShowCode from '@/shared/showcode/showcode';
import { popovers1, popovers2, popovers3, popovers4, popovers5, popovers6, popovers7 } from "../../../shared/data/prismdata/uielementsprim";
...
const Popoovers = () => {
    ...
    return (
        <Fragment>
            <Seo title={"Popovers"} />
            <PageheaderDB heading="Ui Elements" active="Popovers" />
            <div className="main-container container-fluid">
                ...
                <Row>
                    <Col xl={6}>
                        <ShowCode title="Dismissible Popovers" customCardClass="custom-card" customCardBodyClass="d-flex flex-wrap justify-content-between dismissiable-popovers" code={popovers5}>
...
Popoovers.layout = "Contentlayout";

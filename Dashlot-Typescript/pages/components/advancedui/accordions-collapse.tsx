...
import { accordion1, accordion10, accordion11, accordion12, accordion13, accordion14, accordion15, accordion16, accordion2, accordion3, accordion4, accordion5, accordion6, accordion7, accordion8, accordion9 } from "../../../shared/data/prismdata/advanceuidata";
...
const Accordionscollapse = () => {
  ...
  return (
    <Fragment>
      ...
      <PageheaderDB heading="Advanced Ui" active="Accordions" />
      <div className="main-container container-fluid">
        <Row>
          ...
          <Col xl={6}>
            <ShowCode title="Always Open Accordion <p class='text-muted subtitle fs-12 fw-normal mt-2'>Omit the <code>data-bs-parent</code>
					attribute on each
        ...
        <Row>
          <Col xl={12}>
            <ShowCode title="Flush Accordion <p class='subtitle text-muted fs-12 fw-normal mt-2'>

...
const Additionalcontent = () => {
    return (
        <Fragment>
            ...
            <PageheaderDB heading="Utilities" active="Additional Content" />
                        ...
                        <Row>
                            ...
                            <Col xl={12}>
                                <Card className="custom-card">
                                    ...
                                    <Card.Body>
                                        <p><Link href="#!" className="pe-none" tabIndex={-1} aria-disabled="true"><code className="text-primary fw-semibold me-1">This link</code></Link> can not be clicked.
                                        </p>
                                        ...
                                        <p className="pe-none mb-0"><Link href="#!" tabIndex={-1} aria-disabled="true" className='me-1'><code>This link</code></Link> can
                                            not be clicked because the <code className="text-primary fw-semibold">pointer-events</code> property is inherited
                                            from its parent. However, <Link href="#!" className="pe-auto">this link</Link> has a <code>pe-auto</code> class and can be clicked.
                                        </p>
                                    </Card.Body>
                                </Card>
                            </Col>
                ...
                <Row>
                    ...
                    <Col xl={6}>
                        <Card className="custom-card">
                            ...
                            <Card.Body>
                                <img className="bd-placeholder-img mw-100 card-img" src="../../../assets/images/media/64.jpg" alt="..." />
                                <div

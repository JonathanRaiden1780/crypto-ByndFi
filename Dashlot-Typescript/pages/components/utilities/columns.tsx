...
const Columns = () => {
    return (
        <Fragment>
            <Seo title={"Columns"} />
            <PageheaderDB heading="Utilities" active="Columns" />
                                ...
                                <Card className="custom-card">
                                    ...
                                    <Card.Body className="bd-example-row">
                                        ...
                                        <div className="container">
                                            ...
                                            <div className="row mb-3">
                                                <Col md={3} className="col-md-4 ms-md-auto">.col-md-3 .ms-md-auto</Col>
                                                <Col md={3} className="col-md-4 ms-md-auto">.col-md-3 .ms-md-auto</Col>
                                            </div>
                                            <Row>
                        ...
                        <Card className="custom-card">
                            ...
                            <Card.Body className="bd-example-row">
                                <div className="container mb-3">
                                    ...
                                    <Row>
                                        <Col md={6} className="col-md-3 offset-md-3">.col-md-6 .offset-md-3
                                        </Col>
                                    </Row>
                                </div>
                        ...
                        <Card className="custom-card">
                            <Card.Body>
                                ...
                                <div className="clearfix">
                                    <img src="../../../assets/images/media/40.png" className="bd-placeholder-img col-md-6 float-md-end mb-3 ms-md-3 rounded img-fluid" alt="..." />
                                    <p>
